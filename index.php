...
<html lang="en">
  ...
  <body>
    <nav role="navigation" class="navbar navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <button type="button" class="navbar-toggle" data-target="#navcoll" data-toggle="collapse">
            ...
            <div class="navbar-collapse collapse" id="navcoll">
    ...
    <div class="jumbotron" id="myContainer">
          <h1>Online Notes Management</h1>
          <p>Your Go-to location for safe and secure notes</p>
          <p>Easy to use, Anytime and Anywhere </p>
