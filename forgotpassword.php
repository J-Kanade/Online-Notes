...
$time = time();
$status = 'pending';
$sql = "INSERT INTO forgotpassword (`user_id`, `keyn`, `time`, `status`) VALUES ('$user_id', '$key', '$time', '$status')";
$result = mysqli_query($link, $sql);
if(!$result){
...
$message .= "http://localhost/Onotes/resetpassword.php?user_id=$user_id&key=$key";
